...
pub fn add(world: &mut World) -> Vec<HandleUntyped> {
    ...
    let objects = vec![
        Object {
            name: "Dark Rock 1",
            cost: 25.0,
            mesh: asset_server.load("nature/dark_rock_1.glb#Mesh0"),
        ...
        Object {
            name: "Dark Rock 2",
            cost: 25.0,
            mesh: asset_server.load("nature/dark_rock_2.glb#Mesh0"),
            image: asset_server.load("test.png"),
            group: ObjectGroup::Rock,
        },
        Object {
            name: "Dark Rock 3",
            cost: 25.0,
            mesh: asset_server.load("nature/dark_rock_3.glb#Mesh0"),
            image: asset_server.load("test.png"),
            group: ObjectGroup::Rock,
        },
    ];
